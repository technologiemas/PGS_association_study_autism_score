In this notebook histograms are plotted to investigate various distributions of the data and their transformations
...
# plot the distribution of the scaled variable m12_aut_sum_scaled
...
# plot the distribution of the log transformed variable m12_aut_sum_log
...
# plot the distribution of the inverse transformed variable m12_aut_sum_inv
ggplot(data, aes(x = m12_aut_sum_inv)) +
  geom_histogram(binwidth = 0.1) +
  labs(title = "Distribution of m12_aut_sum_inv", x = "m12_aut_sum_inv", y = "Count") +
  theme_minimal()

# take the qnorm and pexp
data$m12_aut_sum_qexp = pexp(data$m12_aut_sum)
data$m12_aut_sum_qnorm = qnorm(data$m12_aut_sum_qexp)

# plot the distribution of the qnorm transformed variable m12_aut_sum_qnorm
...
# Check skewness for all variables
```{R}
